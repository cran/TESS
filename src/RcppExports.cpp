...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(equations_pSurvival_rateshift_CPP(lambda, mu, rateChangeTimes, massExtinctionSurvivalProbabilities, samplingProbability, t_low, t_high, T, log));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type T(TSEXP);
    Rcpp::traits::input_parameter< bool >::type log(logSEXP);
    __result = Rcpp::wrap(equations_p1_rateshift_CPP(lambda, mu, rateChangeTimes, massExtinctionSurvivalProbabilities, samplingProbability, t, T, log));
    return __result;
END_RCPP
}
